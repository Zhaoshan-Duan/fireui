...
class MainFragment : Fragment() {
    ...
    // listen for the result of the sign-in process
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        // listen to the sign in request code to come back
    ...
    private fun observeAuthenticationState() {
        ...
        //  accordingly.
        // utilize authentication state variable from the viewModel, and observing the the authentication state
